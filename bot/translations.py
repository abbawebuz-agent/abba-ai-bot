...
TRANSLATIONS = {
    'uz_latin': {
        **HELP_TEXTS['uz_latin'],
        ...
        'PROMO_NOT_ACTIVE_YET': "⏳ Bu promokod hali faollashtirilmagan. U sotuvchiga biriktirilgandan so'ng ishlaydi.",
    ...
    'ru': {
        **HELP_TEXTS['ru'],
        ...
        'PROMO_NOT_ACTIVE_YET': "⏳ Этот промокод ещё не активирован. Он заработает после привязки к продавцу.",
