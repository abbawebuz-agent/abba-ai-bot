...
TRANSLATIONS = {
    'uz_latin': {
        **HELP_TEXTS['uz_latin'],
        ...
        'WEBAPP_LIVE_STREAM_WINNERS_ELECTRICIANS': "G‘oliblar — elektriklar",
        ...
        'WEBAPP_TAB_ELECTRICIANS': "Elektriklar",
        'WEBAPP_TAB_SELLERS': "Sotuvchilar",
        'WEBAPP_PRIZE': "Sovg‘a",
        'WEBAPP_TOP_USERS_TITLE_ELECTRICIANS': "Top elektriklar",
    ...
    'ru': {
        **HELP_TEXTS['ru'],
        ...
        'WEBAPP_LIVE_STREAM_WINNERS_ELECTRICIANS': "Победители — электрики",
        ...
        'WEBAPP_TAB_ELECTRICIANS': "Электрики",
        'WEBAPP_TAB_SELLERS': "Продавцы",
        'WEBAPP_PRIZE': "Приз",
        'WEBAPP_TOP_USERS_TITLE_ELECTRICIANS': "Топ электрики",
